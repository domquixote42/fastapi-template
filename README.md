...
[![codecov](https://codecov.io/gh/domquixote42/fastapi-template/branch/main/graph/badge.svg?token=fastapi-template_token_here)](https://codecov.io/gh/domquixote42/fastapi-template)
[![CI](https://github.com/domquixote42/fastapi-template/actions/workflows/main.yml/badge.svg)](https://github.com/domquixote42/fastapi-template/actions/workflows/main.yml)

Awesome fastapi_template created by domquixote42

## Install

from source
```bash
git clone https://github.com/domquixote42/fastapi-template fastapi_template
cd fastapi_template
make install
```
